...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/plans', destination: '/calendar?section=plans', permanent: true },
      { source: '/planning', destination: '/calendar?section=plans', permanent: true },
      { source: '/reminders', destination: '/calendar?section=reminders', permanent: true },
