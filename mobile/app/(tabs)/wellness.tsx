...
import { WellnessBoardShell } from '@/components/wellness/WellnessBoardShell'

type WellnessTabId = 'affirmations' | 'apology' | 'gratitude' | 'mood' | 'connection' | 'reflection' | 'calm'
