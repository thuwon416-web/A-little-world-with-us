...
const starterMessages = ['I am here with you.', 'I am proud of us.', 'I love the way we grow together.']
...
export default function ReassuranceCounter() {
  ...
  return (
    <WellnessBoardShell title="Reassurance Counter" subtitle="Gentle truths" badge={`${count} notes`}>
      ...
      <View style={styles.form}>
        <TextInput value={draft} onChangeText={setDraft} placeholder="Write a reassuring line" placeholderTextColor="#8f8393" style={styles.input} />
...
const styles = StyleSheet.create({
  ...
  note: { backgroundColor: '#1a1d29', borderWidth: 1, borderColor: '#313146', borderRadius: 14, padding: 12 },
