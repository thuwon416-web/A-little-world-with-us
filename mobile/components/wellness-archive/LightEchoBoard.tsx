...
const starterItems: EchoItem[] = [
  {
    id: 'echo-1',
    title: 'Let one tender thought return more often than the stress',
    tone: 'echo',
    done: true,
  },
  {
    id: 'echo-2',
    title: 'Give the day one gentle voice of reassurance',
    tone: 'warmth',
    done: false,
  },
    ...
    <WellnessBoardShell title="Light Echo" subtitle="Echo rhythm" badge="light">
      ...
      <View style={styles.form}>
        ...
        <TextInput
          ...
          placeholder="Add a repeated reassurance"
