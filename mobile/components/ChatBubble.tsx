...
export function ChatBubble({
  ...
  const remove = () =>
    Alert.alert('Delete message?', 'This removes the attachment and message for both partners.', [
      ...
      <View style={[styles.bubble, isMe ? styles.bubbleMe : styles.bubbleThem]}>
        ...
        {message.type === 'location' && message.location ? (
          ...
          <Image
            ...
            style={styles.photo}
            onError={() => console.warn('Unable to load chat photo')}
          />
          ...
          <TouchableOpacity style={styles.mediaRow} onPress={() => void toggleAudio()}>
            ...
            <Text style={styles.text}>
              {playing
                ? 'Playing voice note'
                : `Voice note${message.mediaDuration ? ` · ${message.mediaDuration}s` : ''}`}
            </Text>
          </TouchableOpacity>
          ...
          <Image
            source={{ uri: message.mediaUrl }}
            style={styles.gif}
            onError={() => console.warn('Unable to load GIF')}
          />
        ) : message.type === 'file' && message.mediaUrl ? (
          <TouchableOpacity
            style={styles.mediaRow}
            onPress={() =>
              void Linking.openURL(message.mediaUrl!).catch((error) =>
