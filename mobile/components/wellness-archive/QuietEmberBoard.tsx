...
import { WellnessBoardShell } from '../wellness/WellnessBoardShell'

type EmberItem = {
  id: string
  feeling: string
  tone: 'ember' | 'slow' | 'safe' | 'still'
  done: boolean
}
...
const starterItems: EmberItem[] = [
  {
    id: 'ember-1',
    feeling: 'Let a small tender feeling sit without rushing it away',
    tone: 'ember',
    done: true,
  },
  {
    id: 'ember-2',
    feeling: 'Give yourself the space to feel quietly what is real',
    tone: 'slow',
    done: false,
  },
  {
    id: 'ember-3',
    feeling: 'Hold what is fragile with the gentleness it deserves',
    tone: 'safe',
    done: true,
  },
]
...
export default function QuietEmberBoard() {
  ...
  const addItem = () => {
    ...
    setItems((current) => [
      ...current,
      { id: `ember-${Date.now()}`, feeling: value, tone, done: false },
    ])
    setFeeling('')
  }
    ...
    <WellnessBoardShell title="Quiet Ember" subtitle="Ember care" badge="ember">
      ...
      <View style={styles.form}>
        ...
        <TextInput
          ...
          placeholder="What quiet feeling needs care?"
