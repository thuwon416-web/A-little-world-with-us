...
const starterItems: EchoItem[] = [
  { id: 'echo-1', title: 'The moment your smile made the room feel lighter', tone: 'warm', done: true },
  { id: 'echo-2', title: 'A conversation that felt easy without being forced', tone: 'easy', done: false },
  ...
  return (
    <WellnessBoardShell title="Day Echo" subtitle="Echo meter" badge="echo">
      ...
      <View style={styles.form}>
        ...
        <TextInput value={title} onChangeText={setTitle} placeholder="Capture a lingering feeling" placeholderTextColor="#8f8393" style={styles.input} />
