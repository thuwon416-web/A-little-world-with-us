  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'h-md': ['24px', { lineHeight: '32px' }],
        'h-lg': ['28px', { lineHeight: '36px' }],
        'd-sm': ['36px', { lineHeight: '44px' }],
        'd-lg': ['48px', { lineHeight: '56px' }],
      },
      spacing: {
        // B2 spacing tokens
        xs: '4px',
      ...
      colors: {
        ...
        'card-title': 'rgb(var(--card-title) / <alpha-value>)',
        'stat-bg': 'rgb(var(--stat-bg) / <alpha-value>)',
        'stat-border': 'rgb(var(--stat-border) / <alpha-value>)',
        'soft-tint': 'rgb(var(--soft-tint) / <alpha-value>)',
