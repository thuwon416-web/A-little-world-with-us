...
export default function KindnessRootsBoard() {
  ...
  return (
    <WellnessBoardShell title="Kindness Roots" subtitle="Rooted care" badge="roots">
      <View style={styles.progressCard}>
        <View style={styles.progressHeader}>
          <Text style={styles.progressLabel}>Rooted care</Text>
      ...
      <View style={styles.promptCard}>
        <View style={styles.promptHeader}>
          <Text style={styles.promptLabel}>Gentle prompt</Text>
