...
> = {
  ...
  home: { label: 'home', style: { backgroundColor: '#2b2131', borderColor: '#d8b9c8' } },
}
...
export default function WarmWindowBoard() {
  ...
  return (
    <WellnessBoardShell title="Warm Window" subtitle="Window view" badge="window">
      <View style={styles.progressCard}>
        <View style={styles.progressHeader}>
          <Text style={styles.progressLabel}>Window view</Text>
        ...
        {items.map((item) => (
          ...
          >
            <View style={styles.itemInner}>
              <View style={[styles.pill, viewMeta[item.view].style]}>
                <Text style={styles.pillText}>{viewMeta[item.view].label}</Text>
              </View>
              <Text style={[styles.itemText, item.done && styles.itemTextDone]}>{item.title}</Text>
            </View>
            <Text style={styles.itemState}>{item.done ? 'opened' : 'later'}</Text>
          </Pressable>
        ))}
      </View>
