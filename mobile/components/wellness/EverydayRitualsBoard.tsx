...
type RitualItem = { id: string; title: string; kind: 'morning' | 'midday' | 'evening' | 'reset'; done: boolean }

const starterItems: RitualItem[] = [
  { id: 'ritual-m1', title: 'Message each other a soft good morning', kind: 'morning', done: true },
  { id: 'ritual-d1', title: 'Take one slow breath before checking messages', kind: 'reset', done: false },
...
const kindMeta: Record<RitualItem['kind'], { label: string; style: { backgroundColor: string; borderColor: string } }> = {
  morning: { label: 'morning', style: { backgroundColor: '#2d2234', borderColor: '#d8b9c8' } },
  midday: { label: 'midday', style: { backgroundColor: '#171d29', borderColor: '#b7c3f0' } },
  evening: { label: 'evening', style: { backgroundColor: '#1c2129', borderColor: '#b0d8c5' } },
  reset: { label: 'reset', style: { backgroundColor: '#2a2131', borderColor: '#d8b9c8' } },
}
...
export default function EverydayRitualsBoard() {
  ...
  return (
    <WellnessBoardShell title="Everyday Rituals" subtitle="Ritual log" badge="rituals">
      <View style={styles.progressCard}>
        <View style={styles.progressHeader}>
          <Text style={styles.progressLabel}>Ritual log</Text>
      ...
      <View style={styles.form}>
        ...
        <TextInput value={title} onChangeText={setTitle} placeholder="Add a ritual" placeholderTextColor="#8f8393" style={styles.input} />
      ...
      <View style={styles.promptCard}>
        ...
        <Text style={styles.promptText}>{warmPrompts[promptIndex]}</Text>
      </View>
    </WellnessBoardShell>
  )
}
