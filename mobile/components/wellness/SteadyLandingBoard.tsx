...
const starterItems: LandingItem[] = [
  {
    id: 'landing-1',
    title: 'Find a grounded moment that holds steady',
    kind: 'ground',
    done: true,
  },
  {
    id: 'landing-2',
    title: 'Let yourself land safely without needing to keep moving',
    kind: 'safe',
    done: false,
  },
  {
    id: 'landing-3',
    title: 'Build a stable foundation for what comes next',
    kind: 'stable',
    done: true,
  },
]
...
export default function SteadyLandingBoard() {
  ...
  const addItem = () => {
    ...
    setItems((current) => [
      ...current,
      { id: `landing-${Date.now()}`, title: value, kind, done: false },
    ])
    setTitle('')
  }
    ...
    <WellnessBoardShell title="Steady Landing" subtitle="Landing zone" badge="landing">
      ...
      <View style={styles.form}>
        ...
        <TextInput
          ...
          placeholder="Add a grounding moment"
