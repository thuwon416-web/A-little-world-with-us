      ...
      <View style={styles.form}>
        <View style={styles.optionRow}>
          {(['warm', 'gentle', 'bright', 'steady'] as LanternItem['glow'][]).map((option) => (
            <Pressable
              key={option}
              onPress={() => setGlow(option)}
              style={[styles.option, option === glow && styles.optionSelected]}
            >
              <Text style={[styles.optionText, option === glow && styles.optionTextSelected]}>
                {option}
              </Text>
            </Pressable>
          ))}
        ...
        <TextInput
          ...
          placeholder="Add a light moment"
