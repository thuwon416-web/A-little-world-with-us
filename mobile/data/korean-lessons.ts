...
export const KOREAN_LESSONS: KoreanLesson[] = [
  [
    ...
    'Basic Consonants',
    'အခြေခံဗျည်းများ',
    'Learn the 14 basic Korean consonants.',
    1,
  ],
  [
    ...
    'Double Consonants',
    'တင်းကျပ်ဗျည်းများ',
    'Learn the five Korean double consonants.',
    2,
  ],
  ...
  [
    ...
    'Compound Vowels',
    'ပေါင်းစပ်သရများ',
    'Learn the eleven compound Korean vowels.',
    4,
  ],
  [
    'kr-l2-greetings',
    ...
    'Greetings',
    'နှုတ်ဆက်စကားများ',
    'Learn common Korean greetings and introductions.',
    5,
  ],
  [
    'kr-l2-politeness',
    2,
    'Polite Expressions',
    'ယဉ်ကျေးသောအသုံးအနှုန်းများ',
    'Practice polite phrases for everyday conversations.',
    6,
  ],
  [
    'kr-l3-numbers',
    ...
    'Numbers',
    'ဂဏန်းများ',
    'Learn Sino-Korean and native Korean numbers from one to ten.',
    7,
  ],
  [
    'kr-l3-days',
    ...
    'Days of the Week',
    'တစ်ပတ်တာနေ့များ',
    'Learn the Korean names for the days of the week.',
    8,
  ],
  ...
  [
    ...
    3,
    'Common Verbs',
    'အသုံးများသောကြိယာများ',
    'Learn verbs for everyday actions.',
    12,
  ],
  [
    'kr-l3-places',
    ...
    'Learn vocabulary for familiar places.',
    13,
  ],
