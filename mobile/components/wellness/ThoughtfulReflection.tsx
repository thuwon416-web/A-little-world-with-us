...
const kindMeta: Record<Item["kind"], { label: string; style: { backgroundColor: string; borderColor: string } }> = {
...
export default function function ThoughtfulReflection() {
  ...
  const addItem = () => {
    ...
    if (!value) return
    setItems((current) => [...current, { id: `item-${Date.now()}`, title: value, kind, done: false }])
    setTitle("")
  }
  ...
  return (
    <WellnessBoardShell title="Thoughtful Reflection" subtitle="Subtitle" badge="badge">
      ...
      <View style={styles.form}>
        ...
        <TextInput value={title} onChangeText={setTitle} placeholder="Add a moment" placeholderTextColor="#8f8393" style={styles.input} />
